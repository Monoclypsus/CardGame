...
public class Card {
    ...
    public String getCardIcon(String cardDetails) {
        ...
        } else if (cardDetails.equals("JOKER of SPADES")) {
            cardIcon = "black_joker";
        }
        ...
        } else if (cardDetails.equals("JOKER of CLUBS")) {
            cardIcon = "black_joker";
        }
        ...
        } else if (cardDetails.equals("JOKER of HEARTS")) {
            cardIcon = "black_joker";
        }
        ...
        } else if (cardDetails.equals("JOKER of DIAMONDS")) {
            cardIcon = "black_joker";
        }
