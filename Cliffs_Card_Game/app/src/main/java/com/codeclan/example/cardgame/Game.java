...
public class Game {
    ...
    public String getResult(int player1HandNewValue, int player2HandNewValue) {
        int player1HandNewValue1 = player1HandNewValue;
        int player2HandNewValue1 = player2HandNewValue;
        result = rule.getResult(player1HandNewValue1, player2HandNewValue1);
        if (result.equals("Player1")) {
            resultMessage = "You win!!!";
        } else if (result.equals("Player2")) {
            resultMessage = "The dealer wins!!!";
        } else {
